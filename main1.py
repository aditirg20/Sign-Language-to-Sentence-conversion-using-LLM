...
def stop_capture():
    ...
    if captured_signs:
        ...
        response = chat.send_message(str(complete_word + "MAKE A GRAMMATICALLY CORRECT SENTENCE USING THESE WORDS "))
...
sentence_label.pack(side=tk.TOP)  # Change the side to TOP
